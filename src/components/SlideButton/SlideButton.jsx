...
const SlideButton = ({state, handler, label, style, show, variants = null}) => {
        ...
        return (
            <motion.div className='Slide-container' style={style} variants={variants}>
                ...
                <div className="switch" data-on={state} onClick={toggleSwitch}>
                    <motion.div className="handle" layout transition={spring} animate={{opacity:[0,.5, 1], transition: { delay: .7 } }}/>
                </div>
            </motion.div>
        );
    } else {
